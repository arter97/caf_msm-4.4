...
#define SDE_LK_INTERMIDIATE_STOP	0xBEEFBEEF
#define SDE_LK_KERNEL_SPLAH_TALK_LOOP	20
...
static inline void _sde_splash_notify_lk_stop_splash(struct sde_hw_intr *intr)
{
	 ...
	 */
	while (i++ < SDE_LK_KERNEL_SPLAH_TALK_LOOP) {
		if ((SDE_LK_INTERMIDIATE_STOP ==
	...
	if (i == SDE_LK_KERNEL_SPLAH_TALK_LOOP)
