...
static const struct snd_kcontrol_new spkr_i2s_mixer_controls[] = {
	SOC_SINGLE_EXT("MultiMedia1", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA1, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia2", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA2, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia3", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA3, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia4", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA4, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia5", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA5, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia6", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA6, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia7", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA7, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
	SOC_SINGLE_EXT("MultiMedia8", MSM_BACKEND_DAI_AUDIO_I2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA8, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
};
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	*/
	...
	SND_SOC_DAPM_AIF_OUT("QUAT_MI2S_RX", "Quaternary MI2S Playback",
						0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("AUDIO_I2S_RX", "Speaker I2S Playback",
				0, 0, 0, 0),
	...
	SND_SOC_DAPM_MIXER("AUDIO_I2S_RX Audio Mixer", SND_SOC_NOPM, 0, 0,
				spkr_i2s_mixer_controls,
				ARRAY_SIZE(spkr_i2s_mixer_controls)),
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia1", "MM_DL1"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia2", "MM_DL2"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia3", "MM_DL3"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia4", "MM_DL4"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia5", "MM_DL5"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia6", "MM_DL6"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia7", "MM_DL7"},
	{"AUDIO_I2S_RX Audio Mixer", "MultiMedia8", "MM_DL8"},
	{"AUDIO_I2S_RX", NULL, "AUDIO_I2S_RX Audio Mixer"},
